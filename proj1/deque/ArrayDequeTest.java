...
public class ArrayDequeTest {
    ...
    @Test
    public void ADRandomTest() {
        ArrayDeque<Integer> broken = new ArrayDeque<Integer>();
        StudentArrayDeque<Integer> correct = new StudentArrayDeque<>();
        int N = 500;
        for (int i = 0; i < N; i++) {
            int operationNumber = StdRandom.uniform(3);
